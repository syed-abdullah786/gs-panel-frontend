...
function Employee() {
  return (
    <>
    <div className="card-header-title fsize-2 text-capitalize font-weight-normal mt-4 mb-2" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
      <p>Employees</p>
      <Model/>
      {/* <Button outline className="mb-2 me-2 btn-transition" color="primary">Add New Employee</Button> */}
    </div>
    ...
    <table className="align-middle mb-0 table table-borderless table-striped table-hover">
        ...
        <tr>
            ...
            <td className="text-center">
            <Button className="mb-2 me-2" color="primary">Details</Button>
            </td>
        </tr>
        <tr>

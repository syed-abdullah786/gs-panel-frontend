...
import {MainNav, ComponentsNav, FormsNav, WidgetsNav, ChartsNav, AccountNav, ToolboxNav} from './NavItems';
    ...
    render() {
        return (
            <Fragment>
                ...
                <MetisMenu content={ToolboxNav} activeLinkFromLocation className="vertical-nav-menu" iconNamePrefix="" classNameStateIcon="pe-7s-angle-down"/>
